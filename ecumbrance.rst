...
Правообладателям ``whoseRightRestricted``, собственность которых находится в совместном владение ``cooperativeOwnership`` необходимо предоставить **"Свидетельство о браке"**  или **"Брачный договор"** .
