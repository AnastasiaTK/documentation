...
Представляет собой следующий набор данных:
  ...
  * docflow - Набор данных описывающие состояние документооборота
        ...
        Docflow так же может содержать:
            ...
            * error - описание ошибки ( :doc:`response/error`), в случае возникновении ошибки при обработки запроса.
            * requirements - описание действий :doc:`response/requirements`, которые нужно совершить для продолжения обработки запроса
            * result - результат обработки запроса в Росреестре ( :doc:`response/result`), если документооборот находится в состоянии ``completed``.
