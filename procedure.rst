...
После создания ДО API Контур.Реестро на основании полученных данных проверяет наличие требований (:ref:`requirements<response/>`)  к данному ДО. 
...
Когда все документы подписаны можно переходить к :ref:`отправке ДО<Отправка документооборота>`.
