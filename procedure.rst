...
На изображении представлен алгоритм работы с API контур Реестро. Детльное описание методов представлено ниже -> 
...
.. note::
 ...
 После подписания документов  необходимо перейти к этапу отправки документооборота.
