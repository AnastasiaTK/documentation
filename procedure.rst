...
После создания ДО API Контур.Реестро на основании полученных данных проверяет наличие требований (:doc:`requirements<requirements>`)  к данному ДО. 
  ...
  * если они определены, то пользователю возвращаются :doc:`requirements`.
...
Если после создания ДО, он переходит в состояние ``suspend`` -> ДО присвоено требование :ref:`signature<requirements>`.
